<?php
    ...
    //  Organizando a linha para ser excluídada no arquivo .txt
    $linha_del = $nome . ";" . $matricula . ";" . $dtNasc . ";" . $email . ";" . $cpf . ";" . $fone;
    $linha_del = $linha_del . ";" . $endereco . ";" . $cidade . ";" . $estado . ";" . $cep;
    ...
    if ($arquivo) {
        ...
        while(true) {
            ...
            if(preg_match("/$matricula/", $linha)) {
                ...
                $string = array_diff($linha, array($linhas));
